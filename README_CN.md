...
# [English](https://github.com/jcasbin/casbin-spring-boot-3-starter)|中文

Casbin Spring Boot 3 Starter 用于帮助你在Spring Boot 3.0项目中轻松集成[jCasbin](https://github.com/casbin/jcasbin)。

## 如何使用

1. 在 Spring Boot 项目中加入```casbin-spring-boot-3-starter```依赖
